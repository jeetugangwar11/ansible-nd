...
class EpManageFabricsPoolsGet(BaseModel):
    """
    # Summary
    ...
    def path(self) -> str:
        ...
        """
        log.debug(
            "Building path for ManageGetFabricsPools: fabric_name=%s, pool_id=%s",
            self.fabric_name,
            self.endpoint_params.pool_id,
        )
        base_path = BasePath.path("fabrics", self.fabric_name, "pools")
    ...
    def verb(self) -> HttpVerbEnum:
        ...
        log.debug(
            "Returning HTTP verb for ManageGetFabricsPools: verb=%s", HttpVerbEnum.GET
        )
...
class EpManageFabricsProposeVlanGet(BaseModel):
    """
    # Summary
    ...
    request = EpManageFabricsProposeVlanGet()
    request.fabric_name = "fabric1"
    ...
    def path(self) -> str:
        ...
        """
        log.debug(
            "Building path for EpManageFabricsProposeVlanGet: fabric_name=%s, vlan_type=%s, tenant_name=%s",
            self.fabric_name,
            self.endpoint_params.vlan_type,
            self.endpoint_params.tenant_name,
        )
        base_path = BasePath.path("fabrics", self.fabric_name, "proposeVlan")
    ...
    def verb(self) -> HttpVerbEnum:
        """Return the HTTP verb for this endpoint."""
        log.debug(
            "Returning HTTP verb for EpManageFabricsProposeVlanGet: verb=%s",
            HttpVerbEnum.GET,
        )
        return HttpVerbEnum.GET
...
class EpManageFabricResourcesActionsRemoveResourcePost(BaseModel):
    """
    # Summary
    ...
    request = EpManageFabricResourcesActionsRemoveResourcePost()
    request.fabric_name = "fabric1"
    path = request.path
    verb = request.verb
    ...
    def path(self) -> str:
        ...
        """
        log.debug(
            "Building path for EpManageFabricResourcesActionsRemoveResourcePost: fabric_name=%s",
            self.fabric_name,
        )
        return BasePath.path(
    ...
    def verb(self) -> HttpVerbEnum:
        """Return the HTTP verb for this endpoint."""
        log.debug(
            "Returning HTTP verb for EpManageFabricResourcesActionsRemoveResourcePost: verb=%s",
            HttpVerbEnum.POST,
        )
        return HttpVerbEnum.POST
...
class EpManageFabricResourceByIdGet(BaseModel):
    """
    # Summary
    ...
    ```python
    # Get resource by ID
    request = EpManageFabricResourceByIdGet()
    request.fabric_name = "fabric1"
    ...
    def path(self) -> str:
        ...
        """
        log.debug(
            "Building path for EpManageFabricResourceByIdGet: fabric_name=%s, resource_id=%s",
            self.fabric_name,
            self.resource_id,
        )
        return BasePath.path(
    ...
    def verb(self) -> HttpVerbEnum:
        """Return the HTTP verb for this endpoint."""
        log.debug(
            "Returning HTTP verb for EpManageFabricResourceByIdGet: verb=%s",
            self.http_verb,
        )
...
class EpManageFabricResourceByIdDelete(BaseModel):
    """
     # Summary
    ...
    # Delete resource by ID
     request = EpManageFabricResourceByIdDelete()
     request.fabric_name = "fabric1"
     request.resource_id = 100
    ...
    def path(self) -> str:
        ...
        """
        log.debug(
            "Building path for EpManageFabricResourceByIdDelete: fabric_name=%s, resource_id=%s",
            self.fabric_name,
            self.resource_id,
        )
        return BasePath.path(
    ...
    def verb(self) -> HttpVerbEnum:
        """Return the HTTP verb for this endpoint."""
        log.debug(
            "Returning HTTP verb for EpManageFabricResourceByIdDelete: verb=%s",
            self.http_verb,
        )
        return self.http_verb
...
class EpManageFabricUnusedVlansGet(BaseModel):
    """
    # Summary
    ...
    ```python
    # Get unused VLANs
    request = EpManageFabricUnusedVlansGet()
    request.fabric_name = "fabric1"
    request.endpoint_params.vlan_type = "networkVlan"
    request.endpoint_params.switch_id = "leaf-101"
    path = request.path
    ...
    def path(self) -> str:
        ...
        """
        log.debug(
            "Building path for EpManageFabricUnusedVlansGet: fabric_name=%s, vlan_type=%s, switch_id=%s, tenant_name=%s",
            self.fabric_name,
            self.endpoint_params.vlan_type,
            self.endpoint_params.switch_id,
            self.endpoint_params.tenant_name,
        )
        base_path = BasePath.path("fabrics", self.fabric_name, "unusedVlans")
        query_string = self.endpoint_params.to_query_string()
        if query_string:
            return f"{base_path}?{query_string}"
        return base_path
    ...
    def verb(self) -> HttpVerbEnum:
        """Return the HTTP verb for this endpoint."""
        log.debug(
            "Returning HTTP verb for EpManageFabricUnusedVlansGet: verb=%s",
            HttpVerbEnum.GET,
        )
        return HttpVerbEnum.GET
